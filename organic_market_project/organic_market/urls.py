...
urlpatterns = [
    ...
    path(
        ...
        add_farmer_product,
        name="add_farmer_product",
    ),

    path(
        "api/farmer/toggle-status/<int:product_id>/",
        toggle_product_status,
        name="toggle_product_status",
    ),

    path(
        "api/farmer/delete-product/<int:product_id>/",
        delete_farmer_product,
        name="delete_farmer_product",
    ),
    ...
    path(
        "api/reviews/<int:product_id>/submit/",
        submit_review,
        name="submit_review",
    ),
    ...
    path(
        "api/get-driver-location/<int:order_id>/",
        get_driver_location,
